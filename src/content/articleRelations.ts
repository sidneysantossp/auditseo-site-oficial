export const articleRelations: Record<string, Array<[string, string]>> = {
  ...
  "autoridade-de-entidade-o-que-e": [
    ...
    ["Como criar conteúdo citável", "/blog/como-criar-conteudo-citavel"],
    ["Schema ajuda a aparecer no ChatGPT?", "/blog/schema-ajuda-aparecer-no-chatgpt"],
  ],
  "geo-o-que-e-o-que-nao-garante": [
    ["Como medir se GEO está funcionando", "/blog/como-medir-se-geo-esta-funcionando"],
    ["O ChatGPT não cita meu site", "/blog/chatgpt-nao-cita-meu-site"],
    ["SEO vs GEO vs AEO", "/blog/seo-vs-geo-vs-aeo"],
  ],
  ...
  "como-auditar-crawlers-de-ia": [
    ...
    ["Site indexado mas ausente em Search AI", "/blog/site-indexado-mas-ausente-em-search-ai"],
  ],
  "como-medir-visibilidade-em-ia": [
    ["Como medir se GEO está funcionando", "/blog/como-medir-se-geo-esta-funcionando"],
    ["Protocolo de benchmark Search AI", "/blog/protocolo-benchmark-search-ai"],
    ["O ChatGPT não cita meu site", "/blog/chatgpt-nao-cita-meu-site"],
  ],
