        ...
        <div className="mx-auto grid max-w-[1240px] gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          ...
          <div className="rounded-[24px] border border-[#11100f]/10 bg-[#11100f] p-8 text-[#f8f8f8]">
            ...
            <ul className="mt-6 space-y-4 text-sm leading-[1.7] text-[#f8f8f8]/70">
              <li>setores e marcas definidos antes da coleta;</li>
              <li>prompts congelados por intenção;</li>
              <li>regras públicas para menção, citação e recomendação;</li>
              <li>repetições e versionamento de coleta;</li>
              <li>revisão humana e limitações junto com os resultados.</li>
            </ul>
